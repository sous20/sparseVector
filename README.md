...
[![R-CMD-check](https://github.com/yourusername/sparseVector/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/yourusername/sparseVector/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
